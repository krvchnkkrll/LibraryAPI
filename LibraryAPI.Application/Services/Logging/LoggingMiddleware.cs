...
namespace LibraryAPI.Application.Services.Logging;
...
public class LoggingMiddleware
{
    ...
    public async Task InvokeAsync(HttpContext context)
    {
        try
        {
            ...
            var routeParams = string.Join(", ", Enumerable.Select<KeyValuePair<string, object?>, string>(context.Request.RouteValues, rv => $"{rv.Key}: {rv.Value}"));
