using LibraryAPI.Application.Handlers.Authors.Commands;
using LibraryAPI.Application.Handlers.Authors.Commands.Create;
using LibraryAPI.Application.Handlers.Authors.Commands.Delete;
using LibraryAPI.Application.Handlers.Authors.Commands.Update;
using LibraryAPI.Application.Handlers.Authors.Queries.GetAllAuthors;
using LibraryAPI.Application.Handlers.Authors.Queries.GetAuthorById;
using MediatR;
